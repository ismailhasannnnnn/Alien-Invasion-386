...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__0{n}.png'), 0, 0.5) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__1{n}.png'), 0, 0.5) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__2{n}.png'), 0, 5) for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/ufo__{n}.png'), 0, 0.7) for n in range(2)]
    bg_img = pg.transform.rotozoom(pg.image.load('images/bg.jpg'), 0, 2.5)
    ...
    def __init__(self, game):
        ...
        self.alien_one = Alien(game=game, sound=self.sound, lasers=None, alien_index=0, image_list=LandingPage.alien_one_imgs,
                               v=Vector(), ul=(centerx - 140, 335))
        self.alien_two = Alien(game=game, sound=self.sound, lasers=None, alien_index=1, image_list=LandingPage.alien_two_imgs,
                               v=Vector(), ul=(centerx - 140, 400))
        self.alien_three = Alien(game=game, sound=self.sound, lasers=None, alien_index=2, image_list=LandingPage.alien_three_imgs,
                               v=Vector(), ul=(centerx - 140, 450))
        self.ufo = Alien(game=game, sound=self.sound, lasers=None, alien_index=3, image_list=LandingPage.ufo_imgs,
                               v=Vector(), ul=(centerx - 140, 515))
    ...
    def draw(self):
        ...
        self.screen.blit(LandingPage.bg_img, (0,0))
        self.alien_one.draw()
        self.alien_two.draw()
